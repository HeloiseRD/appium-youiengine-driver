...
commands.getLocation = async function (el) {
  ...
  log.debug("entering getLocation");
  ...
  log.debug("calling getLocation on server with: " + commandJSON);

  let data = await this.executeSocketCommand(commandJSON);

  log.debug("getLocation return value = " + data);
...
commands.getSize = async function (el) {
  ...
  log.debug("calling getSize on server with: " + commandJSON);

  let data = await this.executeSocketCommand(commandJSON);

  log.debug("getSize return value = " + data);
